   ...
   <div class="materialContainer">
      ...
      <form method="POST" action="/empresasaction" id="formu" onclick="chamada()">
         ...
         <div class="input">
            ...
            <input type="number" class="form-control" id="cnpj" name="cnpj" placeholder="00.000.000/0000-00" style="width: 50%; display: block; float: left;" > 
            <div class="btn pesquisa">
               <button class="btn" id="pesquisar" type="submit" name="pesqui">Pesquisar</button>
            </div>
         </div>
         <div class="input">
