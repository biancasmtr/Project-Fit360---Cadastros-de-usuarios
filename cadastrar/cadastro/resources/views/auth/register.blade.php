...
<div class="materialContainer">
    <div class="box" >
        <div class="title">{{ __('Cadastrar Usuário') }}</div>
               ...
               @csrf
                  ...
                  <div div class="box-emp">
                     <p class="input">Não encontrou sua empresa? 
                        <a href="/cadastro">Cadastre Aqui</a></p>
                  </div>
            ...
            <modal nome="cadastrar" titulo="Cadastrar Empresa">
                  <form id="formAdicionar" css="" action="{{route('empresas.store')}}" method="post">
