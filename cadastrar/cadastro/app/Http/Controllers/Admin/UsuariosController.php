...
class UsuariosController extends Controller
{
    ...
    public function index()
    {
        ...
        $listaModelo = User::all('id','name','email','id_empresa');
        ...
        $listaModelo = DB::table('users')
                        ->join('empresas','empresas.id_empresa','=','users.id_empresa')
                        ->select('users.id','users.name','users.email','empresas.razao_social');
*/
