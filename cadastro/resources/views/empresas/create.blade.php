    ...
    <div class="box" >
        ...
        <div>
         ...
         @endif
            ...
            <form method="POST" action="/empresasaction">
                {{ csrf_field() }}

                  <div class="input">
                     <input type="text" class="form-control" name="razao_social" placeholder="Nome">
                  </div>
                  ...
                  <div class="input">
                        <input type="number" class="form-control" name="cnpj" placeholder="00.000.000/0000-00" >
                  </div>
